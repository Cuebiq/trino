...
public class OpaRestClient {
    ...
    /**
     * Create {@link HttpRequest.Builder} with configured url using provided endpoint
     *
    ...
    /**
     * Gets {@link HttpRequest.BodyPublisher} that is capable of serializing to JSON
     *
    ...
    /**
     * Sends provided request and returns response mapped using {@link HttpResponse.BodyHandler}
     *
